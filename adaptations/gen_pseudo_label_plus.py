...
DATA_DIRECTORY = '/home/user/ws/src/Trans4PASS/datasets/outdoor_8noji_domaindata'
DATA_LIST_PATH = '/home/user/ws/src/Trans4PASS/adaptations/dataset/8noji_list/train.txt'
IGNORE_LABEL = 255
NUM_CLASSES = 19
BATCH_SIZE = 1
NUM_WORKERS = 0
...
def main():
    ...
    for index in range(len(targetset)//BATCH_SIZE):
        ...
        name = name.replace('.png', '_labelIds.png')
